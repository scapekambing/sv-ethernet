...
vunit_util.add_source(lib, RTL_ROOT, "./syn/ethernet/udp_axil_bridge/udp_axil_bridge.sv")
vunit_util.add_source(lib, RTL_ROOT, "./sim/ethernet/udp_axil_bridge/udp_axil_bridge_tb.sv")
