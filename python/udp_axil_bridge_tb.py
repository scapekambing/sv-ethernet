...
vunit_common.add_source(lib, LIB_ROOT / "./sv-axil/syn/axil_if/axil_if.sv")
vunit_common.add_source(lib, LIB_ROOT / "./sv-axil/sim/axil_bfm/axil_bfm.sv")
...
vunit_common.add_source(lib, SYN_ROOT / "./udp_axil_bridge/udp_axil_bridge.sv")
vunit_common.add_source(lib, SIM_ROOT / "./udp_axil_bridge/udp_axil_bridge_tb.sv")

# Create testbench
tb = lib.test_bench("udp_axil_bridge_tb")
